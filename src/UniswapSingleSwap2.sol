...
import "./uniswap/PeripheryImmutableState.sol";
...
contract UniswapSingleSwap2 is IUniswapV3FlashCallback, PeripheryImmutableState, PeripheryPayments {
    ...
    constructor(ISwapRouter _swapRouter, address _factory, address _WETH9) PeripheryImmutableState(_factory, _WETH9) {
        ...
        swapRouter = _swapRouter; // passing in the swap router for simplicity. More advanced contracts will show how to inherit the swap router safely.
    }
